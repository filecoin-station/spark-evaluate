...
/** @import {RetrievalResult, ConsensusCheckError} from './typings.js' */
...
/** @typedef {{
   ...
   indexerResult: string | ConsensusCheckError;
   hasRetrievalMajority: boolean;
   retrievalResult: RetrievalResult
 }} CommitteeEvaluationDetails
 */
export class Committee {
  ...
  constructor ({ cid, minerId }) {
    ...
    /** @type {CommitteeEvaluationDetails | undefined} */
    this.evaluationDetails = undefined
  }
  ...
  evaluate ({ requiredCommitteeSize }) {
    ...
    /** @type {CommitteeEvaluationDetails['retrievalResult']} */
    let retrievalResult
