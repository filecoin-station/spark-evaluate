...
export const evaluate = async ({
  ...
  /** @type {Partial<Record<import('./typings.js').TaskingEvaluation | import('./typings.js').ConsensusCheckError, number>>} */
  ...
  try {
    recordTelemetry('committees', (point) => {
      ...
      point.intField('committees_too_small',
        committees
          .filter(c => c.evaluationDetails?.retrievalResult === 'COMMITTEE_TOO_SMALL')
          .length
      )
