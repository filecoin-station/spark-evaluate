 ...
 * @param {(round: import('./round.js').RoundData) => Promise<void>} args.prepareAcceptedRetrievalTaskMeasurementsCommitment
 */
export const evaluate = async ({
  ...
  try {
    await prepareAcceptedRetrievalTaskMeasurementsCommitment(round)
  } catch (err) {
