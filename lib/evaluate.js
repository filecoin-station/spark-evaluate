...
export const runFraudDetection = async (roundIndex, measurements, { fetchRoundDetails, recordTelemetry }) => {
  ...
  // IMPORTANT: The format string MUST NOT have any placeholder for the roundDetails object
  ...
  if (debug.enabled) {
    for (const m of measurements) {
      ...
      // IMPORTANT: The format string MUST NOT have any placeholder for the `m` object
      debug(
