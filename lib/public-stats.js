...
export const buildProviderRetrievalResultStats = committees => {
...
export const updatePublicStats = async ({ createPgClient, committees, honestMeasurements, allMeasurements, findDealClients }) => {
  const providerRetrievalResultStats = buildProviderRetrievalResultStats(committees)
  const pgClient = await createPgClient()
  try {
    for (const [minerId, retrievalResultStats] of providerRetrievalResultStats.entries()) {
