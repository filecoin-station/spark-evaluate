...
export const updateStationsAndParticipants = async (
  ...
  // for (const [participantId, stationMap] of participantsStationsStats) {
  //   for (const [stationId, stationStats] of stationMap) {
  //     stationParticipants.push({ participantId, stationId })
  //     stats.push(stationStats)
  //   }
  // }
  ...
  // for (const [participantId, subnetSet] of subnets) {
  //   for (const subnet of subnetSet) {
  //     participantSubnets.push({ participantId, subnet })
  //   }
  // }
 ...
 */
export const databaseRefresh = async (
  createPgClient,
