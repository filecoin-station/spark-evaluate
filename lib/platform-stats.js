...
export const updatePlatformStats = async (pgClient, honestMeasurements, allMeasurements) => {
  ...
  await updateDailyStationStats(pgClient, new Date(), honestMeasurements, allMeasurements)
}
 ...
 * @param {import('./preprocess.js').Measurement[]} allMeasurements
 */
export const updateDailyStationStats = async (pgClient, day, honestMeasurements, allMeasurements) => {
 ...
 */
export const updateTopMeasurementStations = async (createPgClient) => {
  try {
    await pRetry(async () => {
