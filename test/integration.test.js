...
describe('preprocess-evaluate integration', () => {
  ...
  it('produces expected results', async function () {
    ...
    assert.deepStrictEqual(committeesStats, {
      measurements_max: '57i',
      measurements_mean: '19i',
      measurements_min: '1i',
      measurements_p1: '2i',
      measurements_p10: '6i',
      measurements_p5: '4i',
      measurements_p50: '19i',
      measurements_p90: '32i',
      measurements_p95: '37i',
      measurements_p99: '47i',
      nodes_max: '57i',
      nodes_mean: '19i',
      nodes_min: '1i',
      nodes_p1: '2i',
      ...
      nodes_p95: '37i',
      nodes_p99: '47i',
      participants_max: '51i',
      participants_mean: '16i',
      participants_min: '1i',
      participants_p1: '2i',
      participants_p10: '4i',
      participants_p5: '3i',
      participants_p50: '16i',
      participants_p90: '28i',
      participants_p95: '33i',
      participants_p99: '41i',
      round_index: '12012i',
      subnets_max: '57i',
      subnets_mean: '19i',
      subnets_min: '1i',
