...
describe('preprocess-evaluate integration', () => {
  ...
  it('produces expected results', async function () {
    ...
    assert.deepStrictEqual(committeesStats, {
      measurements_max: '53i',
      measurements_mean: '15i',
      measurements_min: '1i',
      measurements_p1: '1i',
      measurements_p10: '4i',
      measurements_p5: '2i',
      measurements_p50: '15i',
      measurements_p90: '27i',
      measurements_p95: '32i',
      measurements_p99: '42i',
      nodes_max: '53i',
      nodes_mean: '15i',
      nodes_min: '1i',
      nodes_p1: '1i',
      ...
      nodes_p95: '32i',
      nodes_p99: '42i',
      participants_max: '49i',
      participants_mean: '15i',
      participants_min: '1i',
      participants_p1: '1i',
      participants_p10: '4i',
      participants_p5: '2i',
      participants_p50: '15i',
      participants_p90: '26i',
      participants_p95: '31i',
      participants_p99: '38i',
      round_index: '12012i',
      subnets_max: '53i',
      subnets_mean: '15i',
      subnets_min: '1i',
